    ...
    <div class="banner" :class="{'hide-banner': !showBanner}" :style="bannerBgStyle">
      ...
      >
        <header class="hero">
          ...
          />
          <h1
            v-if="homeData.heroText !== null"
            id="main-title"
          >{{ homeData.heroText || $title || 'Hello' }}</h1>
          <p
            class="description"
          >{{ homeData.tagline || $description || 'Welcome to your VuePress site' }}</p>
...
.home-wrapper {
  .banner {
    ...
    position: relative;
    overflow: hidden;
    background-image: url('https://cdn.jsdelivr.net/gh/Fuukei/Public_Repository/vision/basic/dot.gif') !important;
